...
const Notes = () => {
  ...
  return (
    <div className="container mx-auto">
      <article className="grid p-4 m-3 shadow-lg rounded-2xl shadow-gray-900 justify-self-center justify-items-center bg-ghost">
        ...
        <div className="flex flex-col-reverse justify-center ">
          {notes.map((note) => (
            <div className="h-32 p-4 m-2 shadow bg-neutral shadow-slate-800 rounded-xl" key={`note-key-${note.id}`}>
